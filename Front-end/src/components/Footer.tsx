    ...
    <footer className="bg-muted py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">EnfermeríaOnline</h3>
            <p className="text-muted-foreground">
              Plataforma educativa para profesionales y estudiantes de enfermería que quieren aprender a su propio ritmo.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="#" className="text-muted-foreground hover:text-primary transition-colors">Fundamentos</Link></li>
              <li><Link to="#" className="text-muted-foreground hover:text-primary transition-colors">Farmacología</Link></li>
              <li><Link to="#" className="text-muted-foreground hover:text-primary transition-colors">Especialización</Link></li>
              <li><Link to="#" className="text-muted-foreground hover:text-primary transition-colors">Habilidades Blandas</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-lg font-bold mb-4">Contacto</h3>
            <ul className="space-y-2">
              <li className="text-muted-foreground">Email: info@enfermeriaonline.com</li>
        ...
        <div className="border-t mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; {currentYear} EnfermeríaOnline. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
